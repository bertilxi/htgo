// htgo-gen-api generates an API handler registry from colocated .go files
// Usage: htgo-gen-api [apiDir]
package main
...
import (
	...
	"github.com/bertilxi/htgo/apiutil"
)
...
func generateRegistry(apiDir string, handlers []apiutil.APIInfo) string {
	...
	sb.WriteString(fmt.Sprintf(`// Code generated by htgo-gen-api. DO NOT EDIT.
